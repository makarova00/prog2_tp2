        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <?PHP if ($userData) { ?>
                        <li class="nav-item ">
                            <a class="nav-link" href="index.php?sec=admin_series">Administrar Géneros</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="index.php?sec=admin_artistas">Administrar Músicos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="index.php?sec=admin_guionistas">Administrar Artistas</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link " href="index.php?sec=admin_comics"> Administrar Discos</a>
                        </li>
